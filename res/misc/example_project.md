...
Sometimes I wonder if this is the right thing to do. If this is the right direction. And the truth is, I'm not sure. I think so? I get the feeling that kicking off a blog and doing a personal challenge of weekly writing is something I've been meaning to hop on for a while. So *why not* give it a shot? Why not see what **_happens_**? If I ever stop having fun with it, then I'll stop. If it doesn't feel right anymore, then I'll stop. But for now, let's go all in.
...
Any number of underlining `=`'s or `test`'s will work.
